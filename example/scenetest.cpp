...
void SceneTest::Start()
{
    ...
    Transform3D t(Vector3<float>(250.0f,300.0f,240.0f),Vector3<float>(0.0f,0.0f,0.0f),Vector3<float>(50.0f,50.0f,50.0f));
    RF_3D::objectList[0]->transform = t;
    RF_3D::objectList[1]->transform = t;
    RF_3D::objectList[0]->transform.position.x = 750.0f;
    RF_3D::objectList[1]->transform.position.y = 300.0f;
